...
Every dashboard definition is fully versioned:

- Each save creates a new version
- You can diff any two versions side-by-side
- Rollback to any previous version with one click
- Live updates, viewers see the new version on next refresh without losing scroll position or filter selections
